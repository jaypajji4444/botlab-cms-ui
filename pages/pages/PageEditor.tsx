        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">
              Compose your page by adding and customizing sections.
            </p>
          </div>
        </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 space-y-4 sticky top-6">
            ...
            <div>
              ...
              <div className="flex items-center">
                <span className="bg-gray-100 border border-r-0 border-gray-300 rounded-l-md px-2 py-2 text-gray-500 text-sm">
                  /
                </span>
                <input
                  {...register("slug")}
                  className="w-full border border-gray-300 rounded-r-md px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none"
                  placeholder="home"
                />
              </div>
              {errors.slug && (
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Manage sections and edit their content for this page.
                </p>
              </div>
              <div className="flex space-x-2">
                <select
                    ...
                    {fields.length === 0 && (
                      <div className="text-center py-16 border-2 border-dashed border-gray-200 rounded-xl bg-gray-50">
                        ...
                        <p className="text-sm text-gray-400">
                          Select a template above to add your first section.
                        </p>
                      </div>
                    )}
